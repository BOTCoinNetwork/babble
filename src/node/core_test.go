...
func initR2DynHashgraph(t *testing.T) (cores []*core, bobPeer *peers.Peer, bobKey *ecdsa.PrivateKey) {
	...
	playbook := []play{
		...
		{from: 1, to: 2, payload: [][]byte{[]byte("g21")}},
		{from: 2, to: 0, payload: [][]byte{[]byte("w30")}},
		{from: 0, to: 1, payload: [][]byte{[]byte("w31")}},
		{from: 1, to: 2, payload: [][]byte{[]byte("w32")}},
		{from: 2, to: 1, payload: [][]byte{[]byte("h12")}},
		{from: 1, to: 0, payload: [][]byte{[]byte("w40")}},
		{from: 0, to: 1, payload: [][]byte{[]byte("w41")}},
		{from: 1, to: 2, payload: [][]byte{[]byte("w42")}},
		{from: 2, to: 1, payload: [][]byte{[]byte("i12")}},
		{from: 1, to: 0, payload: [][]byte{[]byte("w50")}},
		{from: 0, to: 1, payload: [][]byte{[]byte("w51")}},
		{from: 1, to: 2, payload: [][]byte{[]byte("w52")}},
		{from: 2, to: 1, payload: [][]byte{[]byte("j12")}},
		{from: 1, to: 0, payload: [][]byte{[]byte("w60")}},
		{from: 0, to: 1, payload: [][]byte{[]byte("w61")}},
		{from: 1, to: 2, payload: [][]byte{[]byte("w62")}},
		{from: 2, to: 1, payload: [][]byte{[]byte("k12")}},
		{from: 1, to: 0, payload: [][]byte{[]byte("w70")}},
		{from: 0, to: 1, payload: [][]byte{[]byte("w71")}},
		{from: 1, to: 2, payload: [][]byte{[]byte("w72")}},
		{from: 2, to: 1, payload: [][]byte{[]byte("l12")}},
		{from: 1, to: 0, payload: [][]byte{[]byte("w80")}},
		{from: 0, to: 1, payload: [][]byte{[]byte("w81")}},
		{from: 1, to: 2, payload: [][]byte{[]byte("w82")}},
	}
